...
\caption{\small Baseline constraints represented in string, feature, and autosegmental representations. Note the string and featural representations for \textsc{*3T} would also include LHH, LHL, and LLH, but these patterns are ruled out by \textsc{*Rise$_{\mu}$}.}
\label{sec:appendix}
\end{table}